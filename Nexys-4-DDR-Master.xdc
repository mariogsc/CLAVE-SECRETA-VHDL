...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { led_p }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { contrasena[0] }]; #IO_L8N_T1_D12_14 Sch=an[4]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { contrasena[1] }]; #IO_L14P_T2_SRCC_14 Sch=an[5]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { contrasena[2] }]; #IO_L23P_T3_35 Sch=an[6]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { contrasena[3] }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
